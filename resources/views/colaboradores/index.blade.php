                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Colaboradores</h3>
                        </div>
                        <div class="card-toolbar">
                        <a href="{{ route('colaborador.new') }}" class="btn btn-primary font-weight-bolder">
                            ...
                            </span>Novo Colaborador</a>
                        </div>
                    </div>
                    <div class="card-body">

                        <div class="row" id="card-colaboradores">
                            <div class="card card-custom">
                                ...
                                <div class='card-footer d-flex justify-content-center'>
                                    ...
                                    <a href='#' class='btn' onclick="remover(${indice})"><span class="svg-icon svg-icon-danger svg-icon-3x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Trash.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"/>
