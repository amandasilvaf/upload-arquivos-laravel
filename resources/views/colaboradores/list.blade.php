                    ...
                    <div class="card-body">
                        ...
                        <div class="row" id="card-colaboradores">
                            @foreach ($colaboradores as $colaborador)
                                <div class="card card-custom text-center bg-secondary m-5">
