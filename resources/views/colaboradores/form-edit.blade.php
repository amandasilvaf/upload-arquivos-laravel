...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        <form action="{{ route('colaborador.update', $colaborador->id)}}" class="form" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="custom-file col-8 mb-4"> 
                    ...
                    <label for="customFileLangHTML" class="custom-file-label" data-browse="Selecionar Nova Foto" ></label> 
                
                </div>

               <div class="card-footer">
                <button type="submit" id="btn_submit" class="btn btn-primary mr-0">Salvar Alterações</button>
